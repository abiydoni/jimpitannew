...
<body class="bg-gray-100 font-poppins text-gray-800">
    <div class="flex flex-col max-h-[10px] max-w-4xl mx-auto p-4 bg-white shadow-lg rounded-lg">
        ...
        <div class="table-container flex-1 border rounded-md mb-4 overflow-y-auto" style="font-size: 12px;">
        <?php if (count($data) > 0): ?>
