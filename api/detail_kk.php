...
<body class="bg-gray-100 font-poppins text-gray-800">
    <div class="flex flex-col max-w-4xl mx-auto p-4 bg-white shadow-lg rounded-lg">
        ...
        <!-- Tombol Kembali -->
        <button id="btnKembali" class="fixed bottom-4 right-4 w-12 h-12 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded-full flex items-center justify-center shadow-lg transition-transform transform hover:scale-110"
...
<script>
    document.getElementById("btnKembali").addEventListener("click", function () {
        if (window.history.length > 1) {
            window.history.back(); // Kembali ke halaman sebelumnya jika ada
        } else {
            window.location.href = "menu.php"; // Jika tidak ada riwayat, kembali ke menu
        }
    });
</script>
