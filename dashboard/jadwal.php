        ...
        <div class="modal-content bg-white p-4 rounded-lg shadow-md w-1/3">
            ...
            <form action="api/change_password.php" method="POST" class="space-y-2">
                ...
                <div class="bg-white p-2 rounded-lg shadow-md">
                    ...
                    <input type="text" id="change_password" name="c_password" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-500" readonly>
