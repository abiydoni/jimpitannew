<?php
// File: warga.php - Versi Gabungan (Lengkap + Perbaikan)
session_start();
include 'header.php';
?>
...
// Fungsi untuk filter data dengan pencarian tanggal lahir yang diperbaiki
...
// Fungsi untuk render tabel dengan tombol kecil
...
// Fungsi untuk print data dengan format landscape
