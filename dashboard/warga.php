                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <div>
                            ...
                            <input placeholder="Nama Lengkap Anda" type="text" name="nama" id="nama" class="w-full border px-2 py-0.5 rounded text-sm form-input placeholder:text-sm" required>
                        </div>
                        <div>
                            <label class="block text-xs font-medium mb-0.5">NIK *</label>
                            <input placeholder="Format: 16 digit angka" type="text" name="nik" id="nik" class="w-full border px-2 py-0.5 rounded text-sm form-input placeholder:text-sm" required maxlength="16" pattern="\d{16}" title="NIK harus 16 digit angka">
                        </div>
                        <div>
                            <label class="block text-xs font-medium mb-0.5">NIK KK *</label>
                            <input placeholder="Format: 16 digit angka" type="text" name="nikk" id="nikk" class="w-full border px-2 py-0.5 rounded text-sm form-input placeholder:text-sm" required maxlength="16" pattern="\d{16}" title="NIK KK harus 16 digit angka">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input placeholder="Tempat Lahir Anda"type="text" name="tpt_lahir" id="tpt_lahir" class="w-full border px-2 py-0.5 rounded text-sm form-input placeholder:text-sm" required>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <div>
                            ...
                            <textarea placeholder="Alamat Lengkap Anda: Desa/Jalan/Gang/Nomor, dll" name="alamat" id="alamat" class="w-full border px-2 py-0.5 rounded text-sm form-input placeholder:text-sm" rows="2" required></textarea>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input placeholder="085..." type="text" name="hp" id="hp" class="w-full border px-2 py-0.5 rounded text-sm form-input placeholder:text-sm">
                        </div>
                    </div>
                </div>
