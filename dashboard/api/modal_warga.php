    ...
    <form id="formWarga" enctype="multipart/form-data" class="px-6 py-4 space-y-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <select name="provinsi" id="provinsi" required class="w-full input border border-gray-300 rounded-md"></select>
        </div>
        <div>
          <label class="block text-sm font-medium">Kabupaten/Kota</label>
          <select name="kota" id="kota" required class="w-full input border border-gray-300 rounded-md"></select>
        </div>
        <div>
          <label class="block text-sm font-medium">Kecamatan</label>
          <select name="kecamatan" id="kecamatan" required class="w-full input border border-gray-300 rounded-md"></select>
        </div>
        <div>
          <label class="block text-sm font-medium">Kelurahan</label>
          <select name="kelurahan" id="kelurahan" required class="w-full input border border-gray-300 rounded-md"></select>
        </div>
      </div>
