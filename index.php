...
<div class="container">
  ...
  <h4 id="totalScan">Jumlah Scan: Rp. <?php echo $totalScan ?> dan <?php echo $totaldata ?> KK</h4>
  ...
  <p style="color:grey; font-size: 10px; text-align: center;">Apabila ada kendala, hubungi: Adi Hermawan</p>
